...
The health consequences followed with a delay but at massive scale. Since the first US Surgeon General’s report in 1964 until 2014, cigarette smoking is estimated to have caused more than 20 million deaths in the United States[^3]. Today that number is around ~0.5 million of people per year[^4]
...
You can predict, or rather let's use the right term - you can _bet_ on everything from the next US president, over the next Nicks-Celtics game all the way to the next Eurosong winner.
